...
INSERT INTO `ddprojservtest`.`instrumentprototypes` (`name`, `c2s`, `s2c`, `type`, `note`, `tag`) VALUES ('gotoGreater', '{\"param1\":{\"type\":\"int\",\"length\":4,\"desc\":\"第一个元素\"},\"param2\":{\"type\":\"int\",\"length\":4,\"desc\":\"第二个元素\"},\"tagName\":{\"type\":\"string\",\"desc\":\"标签名称\"}}', '{}', '4', 'goto的大于判定(只支持整型类型)', '基础系统');
INSERT INTO `ddprojservtest`.`instrumentprototypes` (`name`, `c2s`, `s2c`, `type`, `note`, `tag`) VALUES ('gotoGreaterOrEqual', '{\"param1\":{\"type\":\"int\",\"length\":4,\"desc\":\"第一个元素\"},\"param2\":{\"type\":\"int\",\"length\":4,\"desc\":\"第二个元素\"},\"tagName\":{\"type\":\"string\",\"desc\":\"标签名称\"}}', '{}', '4', 'goto的大于等于判定(只支持整型类型)', '基础系统');
INSERT INTO `ddprojservtest`.`instrumentprototypes` (`name`, `c2s`, `s2c`, `type`, `note`, `tag`) VALUES ('gotoLess', '{\"param1\":{\"type\":\"int\",\"length\":4,\"desc\":\"第一个元素\"},\"param2\":{\"type\":\"int\",\"length\":4,\"desc\":\"第二个元素\"},\"tagName\":{\"type\":\"string\",\"desc\":\"标签名称\"}}', '{}', '4', 'goto的小于判定(只支持整型类型)', '基础系统');
INSERT INTO `ddprojservtest`.`instrumentprototypes` (`name`, `c2s`, `s2c`, `type`, `note`, `tag`) VALUES ('gotoLessOrEqual', '{\"param1\":{\"type\":\"int\",\"length\":4,\"desc\":\"第一个元素\"},\"param2\":{\"type\":\"int\",\"length\":4,\"desc\":\"第二个元素\"},\"tagName\":{\"type\":\"string\",\"desc\":\"标签名称\"}}', '{}', '4', 'goto的小于等于判定(只支持整型类型)', '基础系统');
INSERT INTO `ddprojservtest`.`instrumentprototypes` (`name`, `c2s`, `s2c`, `type`, `note`, `tag`) VALUES ('gotoEqual', '{\"param1\":{\"type\":\"string\",\"desc\":\"第一个元素\"},\"param2\":{\"type\":\"string\",\"desc\":\"第二个元素\"},\"tagName\":{\"type\":\"int\",\"length\":4,\"desc\":\"标签名称\"}}', '{}', '4', 'goto的等于判定(整型，字符串类型)', '基础系统');
INSERT INTO `ddprojservtest`.`instrumentprototypes` (`name`, `c2s`, `s2c`, `type`, `note`, `tag`) VALUES ('gotoNotEqual', '{\"param1\":{\"type\":\"string\",\"desc\":\"第一个元素\"},\"param2\":{\"type\":\"string\",\"desc\":\"第二个元素\"},\"tagName\":{\"type\":\"string\",\"desc\":\"标签名称\"}}', '{}', '4', 'goto的不等于判定(整型，字符串类型)', '基础系统');
INSERT INTO `ddprojservtest`.`instrumentprototypes` (`name`, `c2s`, `s2c`, `type`, `note`, `tag`) VALUES ('gotoNull', '{\"tagName\":{\"type\":\"string\",\"desc\":\"标签名称\"}}', '{}', '4', 'goto的无条件判定', '基础系统');
